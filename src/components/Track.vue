<template>
    <div class="trackBox">
        ...
        <div class="soundBox" v-for="c of contSounds" :key="c">
            ...
            <h5 class="load" v-if="CymbalsSrc==''" @click="getSonidos">Ver sonidos</h5>
            <select class="sound" v-else-if="tipoSonido[c]=='Toms'" :id="c+'type'">
                <option :style="{'background-color':'rgb(65, 65, 65)'}" class="sounds" v-for="t of Toms" :key="t">{{t}} </option>
            </select>
            <select class="sound" v-else-if="tipoSonido[c]=='Snares'" :id="c+'type'">
                <option :style="{'background-color':'rgb(65, 65, 65)'}" class="sounds" v-for="s of Snares" :key="s">{{s}} </option>
            </select>
            <select class="sound" v-else-if="tipoSonido[c]=='Kick'" :id="c+'type'">
                <option :style="{'background-color':'rgb(65, 65, 65)'}" class="sounds" v-for="k of Kicks" :key="k">{{k}} </option>
            </select>
            <select class="sound" v-else-if="tipoSonido[c]=='Cymbals'" :id="c+'type'">
                <option :style="{'background-color':'rgb(65, 65, 65)'}" class="sounds" v-for="c of Cymbals" :key="c">{{c}} </option>
            </select>
           <div v-for="cont of cont" :key="cont+'-'+c">
               <div class="block" @click="activeBlocks(c+''+cont), playSound(c+''+cont+'s'),soundsList(c,cont,c+''+cont)" :id="c+''+cont"><audio :id="c+''+cont+'s'" src=""></audio>_</div>
           </div>
        ...
        <h3 class="sel" @click="getId">Seleccionar</h3>
...
<script>
import {kickPromise, tomsPromise, snaresPromise, cymbalsPromise, kickSoundPromise, tomsSoundPromise, snaresSoundPromise, cymbalsSoundPromise} from "../sounds";
